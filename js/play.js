...
function video_title(){
	var val = '';
	if(vidow_title_f){
		val = '<a href="http://100123123.com" target="_blank">今日头条→2018最新网赚项目￥教你简单在家日赚800,不是梦！</a>';
	}
	else
	val = '<a href="http://100123123.com" target="_blank">点击访问100123123.com或加微信号www995898</a>';
	var iframe = document.getElementById("cciframe").contentWindow;
